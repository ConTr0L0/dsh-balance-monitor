...
.bm-pop-header{flex:none;display:flex;align-items:center;gap:8px;padding:12px 14px;border-bottom:1px solid color-mix(in srgb,var(--dsw-alias-label-primary) 8%,transparent);cursor:grab;user-select:none}
...
function FloatWindow({
  ...
  const roots = sessions.filter((session) => !session.parentSession || !byId.has(session.parentSession)).sort((a, b) => (b.lastEvent ?? 0) - (a.lastEvent ?? 0));
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "bm-list-row-main", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "bm-list-sub", children: [
                ...
                " ",
                t("req"),
                hasChildren ? ` · ${children.length} ${t("subSessions")}` : ""
              ] })
            ] }),
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "bm-pop-body", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Card, { children: [
              ...
              visibleRoots.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "bm-empty", children: t("noSessions") }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "bm-list", children: visibleRoots.map((root) => renderGroup(root)) })
            ] }),
