...
/* collapsed rail: vertical oval plate (peak dot + balance only) */
...
/* charts + heatmap */
.bm-chart{display:flex;align-items:flex-end;gap:6px;height:160px;padding-top:4px;position:relative}
...
/* model filter chips */
.bm-model-filter{display:flex;flex-wrap:nowrap;overflow-x:auto;align-items:center;gap:6px;padding-bottom:2px;scrollbar-width:thin}
.bm-filter-chip{appearance:none;display:inline-flex;align-items:center;gap:5px;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);color:var(--dsw-alias-label-tertiary);font:inherit;font-size:10px;border-radius:999px;padding:4px 9px;cursor:pointer;opacity:.6;white-space:nowrap;flex:none}
...
.bm-notice{width:100%;min-width:0;overflow-x:auto}
.bm-notice-dialog{width:min(640px,94vw)!important}
.bm-notice-table{width:100%;border-collapse:collapse;font-size:12px;color:var(--dsw-alias-label-primary)}
.bm-notice-table th{text-align:left;font-weight:500;font-size:11px;color:var(--dsw-alias-label-secondary);padding:5px 6px;border-bottom:1px solid var(--dsw-alias-border-l2);white-space:nowrap}
.bm-notice-table td{padding:6px;border-bottom:1px solid var(--dsw-alias-border-l3,var(--dsw-alias-border-l2));white-space:nowrap}
...
.bm-notice-price{display:inline-flex;gap:4px;align-items:baseline}
...
function StackedBarChart({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "bm-chart bm-stacked", "data-dense": days > 14 || void 0, children: buckets.map((bucket, index) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          showValues && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "bm-chart-value", children: bucket.total > 0 ? fmtTokens(bucket.total) : "" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "bm-stack", style: { height: `${max > 0 ? Math.max(4, bucket.total / max * 100) : 2}%` }, children: bucket.values.map(
            (value, index2) => value > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "i",
              {
                style: { height: `${value / Math.max(1, bucket.total) * 100}%`, background: modelColor(modelIds[index2]) }
              },
              modelIds[index2]
            ) : null
          ) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "bm-chart-label", children: showLabel ? bucket.label : " " })
        ]
      },
      bucket.key
    );
...
var PrimitivesModal = null;
var PrimitivesButton = null;
try {
  const primitives = require("@deepseek-ai/dsh-client-ui-primitives");
  PrimitivesModal = primitives?.Modal ?? null;
  PrimitivesButton = primitives?.Button ?? null;
} catch {
}
function diffModels(notice) {
  const rows = [];
  const ids = [.../* @__PURE__ */ new Set([...Object.keys(notice.old?.models ?? {}), ...Object.keys(notice.new?.models ?? {})])];
  for (const id of ids) {
...
var fmtWindows = (windows) => (windows ?? []).map(([start, end]) => `${start}–${end}`).join("、") || "—";
function PriceCell({ before, after }) {
  const changed = before !== after;
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "bm-notice-price", children: [
    changed && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("s", { className: "bm-notice-old", children: before }),
    changed && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { "aria-hidden": "true", children: " → " }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "bm-notice-new", "data-changed": changed || void 0, children: after })
  ] });
}
function PricingChangeNotice({ rpc }) {
  const { overview } = (0, import_react2.useSyncExternalStore)(subscribe, getSnapshot);
  ...
  const body = /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "bm-notice", children: [
    rows.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("table", { className: "bm-notice-table", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("tr", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("th", { children: t("noticeColModel") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("th", { children: t("noticeColHit") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("th", { children: t("noticeColMiss") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("th", { children: t("noticeColOut") })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("tbody", { children: rows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("tr", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("td", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "bm-notice-model", children: row.id }),
          row.status !== "changed" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "bm-notice-tag", "data-kind": row.status, children: row.status === "added" ? t("noticeAdded") : t("noticeRemoved") })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PriceCell, { before: row.prev.cacheHit, after: row.next.cacheHit }) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PriceCell, { before: row.prev.input, after: row.next.input }) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PriceCell, { before: row.prev.output, after: row.next.output }) })
      ] }, row.id)) })
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "bm-notice-nomodels", children: t("noticeNoModels") }),
    rules.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "bm-notice-rules", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "bm-notice-rules-title", children: t("noticeRulesTitle") }),
      rules.map((rule) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "bm-notice-rule", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "bm-notice-rule-label", children: rule.label }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "bm-notice-rule-value", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("s", { className: "bm-notice-old", children: rule.before }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { "aria-hidden": "true", children: "→" }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "bm-notice-new", "data-changed": "true", children: rule.after })
        ] })
      ] }, rule.key))
    ] })
  ] });
  if (PrimitivesModal && PrimitivesButton) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      PrimitivesModal,
      {
        ...
        description,
        footer: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PrimitivesButton, { variant: "primary", size: "sm", onClick: dismiss, disabled: busy, children: t("noticeAck") }),
        children: body
      }
    );
  }
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    FallbackModal,
    {
      ...
      description,
      onClose: dismiss,
      footer: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", className: "bm-notice-ack", onClick: dismiss, disabled: busy, children: t("noticeAck") }),
      children: body
    }
  );
}
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "div",
          {
            ...
            style: {
              ...
              overflow: "hidden",
              color: "var(--dsw-alias-label-primary, #14161a)",
              fontFamily: "inherit"
            },
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { padding: "20px 22px 6px" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h2", { className: "bm-notice-fallback-title", children: title }),
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                    "button",
                    {
                      type: "button",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "bm-notice-fallback-desc", children: description }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { padding: "14px 0 4px" }, children })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "bm-notice-fallback-footer", children: footer })
            ]
          }
        )
      }
...
var SafeBoundary = class extends import_react3.Component {
  constructor() {
    super(...arguments);
...
function Card({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SafeBoundary, { fallback: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "bm-empty", children: "—" }), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "bm-card", children }) });
}
function RefreshIcon({ spinning }) {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("svg", { className: spinning ? "bm-spin" : void 0, viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M13.5 8a5.5 5.5 0 1 1-1.6-3.9" }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M13.7 1.8v3.4h-3.4" })
  ] });
}
function CloseIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("svg", { viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M4 4l8 8M12 4l-8 8" }) });
}
function GearIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("svg", { viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("circle", { cx: "8", cy: "8", r: "2.2" }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M8 1.6l.9 1.6 1.8.2 1.3-1.1 1.3 1.3-1.1 1.3.2 1.8 1.6.9-1.6.9-.2 1.8 1.1 1.3-1.3 1.3-1.3-1.1-1.8.2-.9 1.6-.9-1.6-1.8-.2-1.3 1.1L2.7 9.8l1.1-1.3-.2-1.8L2 5.8l1.6-.9.2-1.8L2.7 1.8 4 .5l1.3 1.1 1.8-.2z" })
  ] });
}
...
function SidebarWidget({ wide, rpc }) {
  const snapshot = (0, import_react3.useSyncExternalStore)(subscribe, getSnapshot);
  ...
  const openedAt = (0, import_react3.useRef)(0);
  const lastStatsPoll = (0, import_react3.useRef)(0);
  ...
  (0, import_react3.useEffect)(() => {
    ...
    const refreshStatsSoon = () => {
      const now = Date.now();
      if (now - lastStatsPoll.current < 4e3) return;
      lastStatsPoll.current = now;
      void refreshAll(rpc);
    };
    const timer = window.setInterval(refreshStatsSoon, 6e3);
  ...
  const plateTitle = balanceStale ? `${t("name")} · ${t("staleHint")}` : t("name");
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(SafeBoundary, { fallback: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-empty", children: "—" }), children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      "div",
      {
        ...
        title: plateTitle,
        children: wide ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          display?.showPeak !== false && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "bm-trend", "data-status": peak, "data-tip": peak === "peak" ? t("peak") : t("offpeak"), children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("i", {}),
            peak === "peak" ? t("peakShort") : t("offpeakShort")
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "bm-pill-main", children: [
            display?.showBalance !== false && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              "span",
              {
                className: "bm-primary",
                "data-warn": anyLimitExceeded || void 0,
                "data-critical": anyBlocked || void 0,
                "data-stale": balanceStale || void 0,
                children: balanceLabel
              }
            ),
            display?.showToday !== false && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "bm-secondary", children: [
              t("today"),
              " ",
              currency,
              fmtMoney(todayCost),
          ...
          display?.showRefresh !== false && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "button",
            {
              type: "button",
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(RefreshIcon, { spinning })
            }
          ),
          showRemaining && limitRow && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-strip", "data-warn": limitRow.exceeded || void 0, "data-critical": limitRow.action === "block" && limitRow.exceeded || void 0, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("i", { style: { width: `${Math.min(100, Math.round(limitRow.progress * 100))}%` } }) })
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          display?.showPeak !== false && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "span",
            {
              className: "bm-rail-trend",
              "data-status": peak,
              title: peak === "peak" ? t("peak") : t("offpeak"),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(PricingChangeNotice, { rpc }),
    open && anchor && overview && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FloatWindow, { anchor, onClose: () => setOpen(false), rpc, providerId }),
    open && !overview && error && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "bm-empty", children: error })
  ] });
}
function FloatWindow({
  ...
  const [provider, setProvider] = (0, import_react3.useState)(providerId);
  ...
  const [spinning, setSpinning] = (0, import_react3.useState)(false);
  const [showAllSessions, setShowAllSessions] = (0, import_react3.useState)(false);
  ...
  const providerError = prov?.ok === false ? prov.error === "no-api-key" ? t("noKey") : prov.error ?? null : null;
  ...
  const renderSessionDetail = (session) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-session-detail", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-session-detail-row", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: session.id.slice(0, 8) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "bm-session-chips", children: Object.entries(session.models).map(([id, count]) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("i", { style: { background: modelColor(id) } }),
      id,
      " ×",
      count
    ] }, id)) })
  ...
  const renderSessionRow = (session) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-session-group", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        "div",
        {
          ...
          children: [
            children.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("svg", { className: "bm-session-chevron", "data-open": isOpen || void 0, viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M6 3.5l4.5 4.5L6 12.5" }) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-session-chevron bm-session-leaf" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "bm-list-row-main", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "bm-list-sub", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "bm-list-cost", children: [
              currency,
              fmtMoney(session.cost)
            ] })
          ]
      ...
      isOpen && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-session-children", children: [
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-session-group", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        "div",
        {
          ...
          children: [
            multiple ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("svg", { className: "bm-session-chevron", "data-open": isOpen || void 0, viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M6 3.5l4.5 4.5L6 12.5" }) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-session-chevron bm-session-leaf" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-list-row-main", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-list-title", children: group.title }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "bm-list-sub", children: [
                t("reqLabel"),
                " ",
                group.requests,
                " ",
      ...
      isOpen && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "bm-session-children", children: group.list.map((session) => renderSessionRow(session)) })
    ] }, group.key);
  };
  return (0, import_react_dom2.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "div",
      {
        ...
        "aria-label": t("name"),
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-pop-header", onPointerDown: startDrag, title: t("dragHint"), children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-provider-chip", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              "select",
              {
                ...
                children: displayOptions.map((id) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("option", { value: id, children: PROVIDER_LABELS2[id] ?? id }, id))
              }
            ) }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "bm-trend", "data-status": peak, "data-tip": peak === "peak" ? t("peak") : t("offpeak"), children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("i", {}),
              peak === "peak" ? t("peakFull") : t("offpeakFull")
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { flex: 1 } }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: "bm-iconbtn", onClick: () => void doRefresh(), disabled: spinning, "aria-label": t("refresh"), title: t("refresh"), onPointerDown: (event) => event.stopPropagation(), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(RefreshIcon, { spinning }) }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: "bm-iconbtn", onClick: openSettingsSection, "aria-label": t("openSettings"), title: t("openSettings"), onPointerDown: (event) => event.stopPropagation(), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(GearIcon, {}) }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: "bm-iconbtn", onClick: onClose, "aria-label": "close", title: "close", onPointerDown: (event) => event.stopPropagation(), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CloseIcon, {}) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-pop-body", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Card, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-card-head", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-card-label", children: PROVIDER_LABELS2[provider] ?? provider }),
                prov?.fetchedAt ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "bm-card-meta", children: [
                  t("updated"),
                  " ",
                  timeAgo(prov.fetchedAt)
                ] }) : null
              ] }),
              providerError !== null && !hasBalance ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-big", "data-warn": true, children: "—" }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-note", children: providerError })
              ] }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "bm-big", children: [
                  currency,
                  fmtMoney(primary)
                ] }),
                providerError !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "bm-note", children: [
                  t("staleHint"),
                  typeof prov?.fetchedAt === "number" && prov.fetchedAt > 0 ? ` · ${t("updated")} ${timeAgo(prov.fetchedAt)}` : ""
                ] }) : null,
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-quota-grid", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: t("quotaTotal") }),
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: t("quotaSpent") }),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("strong", { children: [
                      currency,
                ...
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-row", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: t("totalCost") }),
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { children: [
                    currency,
                    fmtMoney(overview.totals.cost),
                    " · ",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "bm-quota-track", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("i", { style: { width: `${Math.round(quotaProgress * 100)}%` } }) }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "bm-note", children: [
                  t("quotaUsed"),
                  " ",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Card, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-row", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: t("today") }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { children: [
                  currency,
                  fmtMoney(today.cost),
                  " · ",
              ...
              enabledLimits.map((row) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-row", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: t(row.labelKey) ?? row.key }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { "data-warn": row.exceeded || void 0, children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("i", { style: { width: `${Math.round(row.progress * 100)}%` } })
                  }
                )
              ] }, row.key))
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Card, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-card-label", children: t("tokensTotal") }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-big bm-big-mid", children: fmtTokens(totalTokens) }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-model-chips", children: topModels.map((row) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "bm-model-chip", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("i", { style: { background: modelColor(row.id) } }),
                row.id,
                " ",
                fmtTokens(row.tokens)
              ] }, row.id)) })
            ] }),
            todayModels.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "bm-models", children: todayModels.map(({ id, stat }) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Card, { children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-card-head", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "bm-model-name", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("i", { style: { background: modelColor(id) } }),
                    id
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-model-tag", children: t("today") })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-quota-grid", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("strong", { children: fmtTokens(tokens) })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: t("consumption") }),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("strong", { children: [
                      currency,
                      fmtMoney(stat.cost)
                    ] })
                ...
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "bm-quota-track", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("i", { style: { width: `${Math.round(share * 100)}%` } }) }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-card-meta-row", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { children: [
                    t("quotaShare"),
                    " ",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Card, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-cal-title", children: t("history7") }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BarChart, { daily: history?.daily ?? {}, days: 7 })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Card, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-months", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: "bm-iconbtn", onClick: () => shiftMonth(-1), "aria-label": "previous", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("svg", { viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M10 3.5L5.5 8l4.5 4.5" }) }) }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { children: [
                  year,
                  " / ",
                  String(month + 1).padStart(2, "0")
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: "bm-iconbtn", onClick: () => shiftMonth(1), disabled: isCurrentMonth, "aria-label": "next", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("svg", { viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M6 3.5l4.5 4.5L6 12.5" }) }) })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(MonthHeatmap, { daily: history?.daily ?? {}, year, month }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-note", children: t("heatNote") })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Card, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bm-row", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "bm-cal-title", children: [
                  t("sessions"),
                  " (",
                  totalGroups,
                  " ",
                ...
                totalGroups > 6 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                  "button",
                  {
                    type: "button",
                    className: "bm-iconbtn",
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("svg", { viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round", children: showAllSessions ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M4 10l4-4 4 4" }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M4 6l4 4 4-4" }) })
                  }
                )
              ] }),
              visibleGroups.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-empty", children: t("noSessions") }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "bm-list", children: visibleGroups.map((group) => renderTitleGroup(group)) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-note", children: t("settingsHint") })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bm-pop-resize", onPointerDown: startResize, title: t("resizeHint") })
        ]
      }
    ),
    document.body
