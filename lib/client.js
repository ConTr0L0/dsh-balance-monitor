...
.bm-widget-rail{height:36px;padding:0 8px;gap:6px}
...
.bm-popover{position:fixed;z-index:50;width:380px;max-height:80vh;display:flex;flex-direction:column;background:color-mix(in srgb,var(--dsw-alias-bg-layer-3) 62%,transparent);backdrop-filter:blur(20px) saturate(1.25);-webkit-backdrop-filter:blur(20px) saturate(1.25);border:1px solid color-mix(in srgb,var(--dsw-alias-label-primary) 13%,transparent);border-radius:24px;box-shadow:0 18px 48px color-mix(in srgb,var(--dsw-alias-label-primary) 22%,transparent);overflow:hidden}
.bm-pop-header{flex:none;display:flex;align-items:center;gap:8px;padding:12px 14px;border-bottom:1px solid color-mix(in srgb,var(--dsw-alias-label-primary) 8%,transparent)}
.bm-provider-chip{display:inline-flex;align-items:center;gap:7px;padding:3px 10px 3px 4px;border-radius:999px;background:color-mix(in srgb,var(--dsw-alias-bg-layer-2) 70%,transparent);border:1px solid color-mix(in srgb,var(--dsw-alias-label-primary) 10%,transparent)}
...
.bm-title-dot{width:6px;height:6px;border-radius:50%;background:var(--dsw-alias-state-success-primary,var(--dsw-alias-label-secondary))}
.bm-title-status{font-size:10px;color:var(--dsw-alias-label-secondary);white-space:nowrap}
.bm-pop-body{overflow-y:auto;padding:14px;display:flex;flex-direction:column;gap:12px;min-height:0}
...
function DonutChart({ models }) {
  const rows = Object.entries(models).map(([id, stat]) => ({ id, tokens: modelTokens(stat), cost: stat.cost })).filter((row) => row.tokens > 0).sort((a, b) => b.tokens - a.tokens);
...
function SettingsCard({ rpc }) {
  ...
  (0, import_react.useEffect)(() => {
    void load();
    const poll = window.setInterval(() => void load(), 6e4);
    return () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bm-settings", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bm-group", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bm-stacked-card", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(StackedBarChart, { daily: history?.daily ?? {}, days: rangeDays }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bm-group", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "bm-group-title", children: t("modelUsage") }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(DonutChart, { models: overview?.models ?? {} })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bm-group", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          display?.showRefresh !== false && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "button",
            {
              type: "button",
  ...
  return (0, import_react_dom.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      "div",
      {
        ...
        style: anchor.top ? { left: anchor.x + 10, bottom: Math.max(8, window.innerHeight - anchor.y + 10) } : { left: anchor.x + 10, top: anchor.y + 10 },
        role: "dialog",
        "aria-label": t("name"),
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "bm-pop-header", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "bm-provider-chip", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "bm-title-dot" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "bm-title-status", children: t("running") })
            ] }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", className: "bm-iconbtn", onClick: openSettingsSection, "aria-label": t("openSettings"), title: t("openSettings"), children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(GearIcon, {}) }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "bm-pop-body", children: [
            ...
            todayModels.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "bm-models", children: todayModels.map(({ id, stat }) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "bm-card", children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "bm-card-head", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "bm-card", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "bm-row", children: [
                ...
                sessions.length > 6 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                  "button",
                  {
                    type: "button",
                    className: "bm-iconbtn",
